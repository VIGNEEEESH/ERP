  ...
  const columns = useMemo(() => [
    {
      Header: 'First Name',
      accessor: 'firstName',
      Cell: ({ value }) => <Typography className="text-sm font-semibold text-blue-gray-600">{value}</Typography>,
    },
    {
      Header: 'Last Name',
      accessor: 'lastName',
    ...
    },
    {
      Header: 'Email',
      accessor: 'email',
      Cell: ({ value }) => <Typography className="text-sm font-normal text-blue-gray-500">{value}</Typography>,
    },
    {
      Header: 'Reason',
      accessor: 'reason',
      ...
      <Card>
        ...
        <CardBody className="p-6">
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="mt-6 bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600"
            >
              Submit
            </button>
          </form>
          <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
            <table {...getTableProps()} className="w-full min-w-[640px] table-auto text-lg">
              <thead>
