...
//     return isPresent ? 'bg-green-500 rounded-full' : 'bg-red-500 rounded-full'; // User is present or not
//   };
...
import 'react-calendar/dist/Calendar.css';
import { AuthContext } from '@/pages/auth/Auth-context';
import './CalenderStyles.css'; // Ensure to import your CSS file here
...
function AttendanceCalendar({ attendanceData }) {
  ...
  const getTileClassName = ({ date }) => {
    ...
    // Determine the background color based on attendance status
    return isPresent ? 'react-calendar__tile--present' : 'react-calendar__tile--absent'; // User is present or not
  };
